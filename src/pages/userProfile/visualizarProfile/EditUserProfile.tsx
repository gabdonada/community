                    ...
                    <div className="card m-2 p-3 d-flex flex-column ">
                        <form onSubmit={handleUserPreferences}>
                            ...
                            <input 
                                ...
                                value={phone || userDef?.userPhone}/>
                            
                            <label className="form-label">Selecione seus interesses</label>
                            <div className='d-flex gap-2 mb-2 d-flex align-items-center'>
                                <input className="form-check-input" type="checkbox" defaultChecked={acRelacaoFins || userDef?.userInterests.acRelacaoFins} onChange={event => {acRelacaoFins === false ? setAcRelacaoFins(true):setAcRelacaoFins(false); handleChangeARF()}}/>
                            ...
                            <div className='d-flex gap-2 mb-2 d-flex align-items-center'>
                                <input className="form-check-input" type="checkbox" defaultChecked={acRelacaoValores || userDef?.userInterests.acRelacaoValores} onChange={event => {acRelacaoValores === false ? setAcRelacaoValores(true):setAcRelacaoValores(false); handleChangeARV()}}/>
                                <label className="form-check-label">
                            ...
                            <div className='d-flex gap-2 mb-2 d-flex align-items-center'>
                                <input className="form-check-input" type="checkbox" defaultChecked={acAfetiva || userDef?.userInterests.acAfetiva} onChange={event => {acAfetiva === false ? setAcAfetiva(true):setAcAfetiva(false); handleChangeAA()}}/>
                                <label className="form-check-label">
                                    Ação social afetiva
                                </label>
                            </div>
                            ...
                            <div className='d-flex gap-2 mb-3 d-flex align-items-center'>
                                <input className="form-check-input" type="checkbox" defaultChecked={acTradi || userDef?.userInterests.acTradi} onChange={event => {acTradi === false ? setAcTradi(true):setAcTradi(false); handleChangeAT()}}/>
                                <label className="form-check-label">
